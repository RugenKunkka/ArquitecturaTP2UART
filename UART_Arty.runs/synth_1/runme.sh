...
HD_PWD='C:/Users/UserTest1/College/CompArq/UART_Arty/UART_Arty.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLevel_UART.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopLevel_UART.tcl
