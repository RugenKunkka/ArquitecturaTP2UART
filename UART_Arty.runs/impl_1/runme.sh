...
HD_PWD='C:/Users/UserTest1/College/CompArq/UART_Arty/UART_Arty.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLevel_UART.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopLevel_UART.tcl -notrace
