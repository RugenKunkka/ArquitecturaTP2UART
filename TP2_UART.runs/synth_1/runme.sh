...
HD_PWD='D:/Facultad/Arquitectura de computadoras/MIS_TPS/TP2_UART/TP2_UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BaudRateGenerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BaudRateGenerator.tcl
